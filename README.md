...
For now, passing an icon in your JSON object is **mandatory**. If you don't have a 13x13 icon at hand, you can use the [doc/showthis_icon_example.png](examples/showthis_icon_example.png) icon in this repo. To convert images to base64 string, you may use a website such as www.base64encode.org.   
